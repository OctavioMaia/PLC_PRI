...
@after{
       ontologia.add("Ontologia IAm\n"+
                        "\nconceitos {"+
	"\nUser[loginType: String, token: String, password: String, name: String, age: String, gender: String, id: String, email: String, address: String, profession: String, type: String, cnumber: String, confirmed: String, aboutme: String],\n"+
	"Post,\n"+
	...
	"Event[eventType: String, hosts: String, guests: String, files: String, text: String, author: String, type: String, ident: String, title: String, location: String, privacy: String, date: String, description: String, pubdate: String,comments: String],\n"+
